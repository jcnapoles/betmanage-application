...
@RestController
@RequestMapping("/api/betmanage-kafka")
public class BetmanageKafkaResource {
    private final Logger log = LoggerFactory.getLogger(BetmanageKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BetmanageKafkaResource(KafkaProperties kafkaProperties) {
