...
public class ParagraphsResourceIT {
    ...
    public void createParagraphs() throws Exception {
        ...
        restParagraphsMockMvc.perform(post("/api/paragraphs").with(csrf())
    ...
    public void updateParagraphs() throws Exception {
        ...
        restParagraphsMockMvc.perform(put("/api/paragraphs").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteParagraphs() throws Exception {
        ...
        restParagraphsMockMvc.perform(delete("/api/paragraphs/{id}", paragraphs.getId()).with(csrf())
