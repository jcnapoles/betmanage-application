...
import com.betpreview.betmanage.config.TestSecurityConfiguration;
import com.betpreview.betmanage.domain.JobHistory;
import com.betpreview.betmanage.repository.JobHistoryRepository;
import com.betpreview.betmanage.repository.search.JobHistorySearchRepository;
import com.betpreview.betmanage.service.JobHistoryService;
...
import com.betpreview.betmanage.domain.enumeration.Language;
/**
 * Integration tests for the {@link JobHistoryResource} REST controller.
 */
@SpringBootTest(classes = { BetmanageApp.class, TestSecurityConfiguration.class })
...
public class JobHistoryResourceIT {
     ...
     *
     * @see com.betpreview.betmanage.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
