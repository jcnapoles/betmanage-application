...
public class MatchPreviewResourceIT {
    ...
    public void createMatchPreview() throws Exception {
        ...
        restMatchPreviewMockMvc.perform(post("/api/match-previews").with(csrf())
    ...
    public void updateMatchPreview() throws Exception {
        ...
        restMatchPreviewMockMvc.perform(put("/api/match-previews").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteMatchPreview() throws Exception {
        ...
        restMatchPreviewMockMvc.perform(delete("/api/match-previews/{id}", matchPreview.getId()).with(csrf())
