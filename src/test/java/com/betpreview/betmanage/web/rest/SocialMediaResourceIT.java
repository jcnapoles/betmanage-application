...
public class SocialMediaResourceIT {
    ...
    public void createSocialMedia() throws Exception {
        ...
        restSocialMediaMockMvc.perform(post("/api/social-medias").with(csrf())
    ...
    public void updateSocialMedia() throws Exception {
        ...
        restSocialMediaMockMvc.perform(put("/api/social-medias").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteSocialMedia() throws Exception {
        ...
        restSocialMediaMockMvc.perform(delete("/api/social-medias/{id}", socialMedia.getId()).with(csrf())
