...
public class TitleResourceIT {
    ...
    public void createTitle() throws Exception {
        ...
        // Create the Title
        restTitleMockMvc.perform(post("/api/titles").with(csrf())
    ...
    public void updateTitle() throws Exception {
        ...
        restTitleMockMvc.perform(put("/api/titles").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteTitle() throws Exception {
        ...
        // Delete the title
        restTitleMockMvc.perform(delete("/api/titles/{id}", title.getId()).with(csrf())
